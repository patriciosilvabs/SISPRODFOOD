...
export const useRomaneioAutomatico = () => {
  ...
  const verificarECriarRomaneiosAutomaticos = async (
    ...
    try {
      ...
      // ✅ TODAS as lojas encerraram - apenas notificar o operador
      console.log('[Romaneio Auto Contagem] ✅ TODAS as lojas encerraram! Operador deve verificar tela de Romaneio.');
      ...
      // Retorna 0 romaneios criados pois agora é 100% manual
      return { romaneiosCriados: 0, aguardandoLojas: [] };
    } catch (error) {
