...
BEGIN
    ...
    -- CORREÇÃO: Usar quantidade_por_lote em vez de total_tracos_lote
    SELECT COALESCE(quantidade_por_lote, 1) INTO v_total_tracos_lote
    ...
    ELSE
        INSERT INTO producao_registros (
            item_id, organization_id, unidades_programadas,
            total_tracos_lote, status, data_referencia,
            usuario_criacao_id, usuario_criacao_nome
        ) VALUES (
            p_item_id, p_organization_id, v_demanda_total,
