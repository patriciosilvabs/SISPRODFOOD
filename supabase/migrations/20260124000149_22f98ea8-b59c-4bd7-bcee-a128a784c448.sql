-- Restaurar função completa com tratamento de lote_masseira e detalhes_lojas
...
BEGIN
    ...
    SELECT 
        ...
        peso_alvo_bolinha_g,
        margem_flexibilizacao_percentual
    INTO v_item
    ...
    IF v_item.unidade_medida = 'lote_masseira' THEN
        ...
        v_margem_percentual := COALESCE(v_item.margem_flexibilizacao_percentual, 0);
