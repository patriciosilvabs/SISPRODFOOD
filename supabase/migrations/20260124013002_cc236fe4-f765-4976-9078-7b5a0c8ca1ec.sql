...
-- Corrigir função criar_ou_atualizar_producao_registro
-- Substituir ORDER BY created_at DESC por ORDER BY id DESC
-- A coluna created_at não existe na tabela producao_registros
...
BEGIN
    ...
    -- CORREÇÃO: Usar ORDER BY id DESC em vez de created_at (coluna não existe)
