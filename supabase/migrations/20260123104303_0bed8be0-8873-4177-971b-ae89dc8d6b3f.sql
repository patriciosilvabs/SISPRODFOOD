-- Criar RPC para recalcular toda a produção do dia baseada nas contagens
...
BEGIN
    ...
    FOR v_item IN 
        ...
        WHERE organization_id = p_organization_id AND status = 'ativo'
    LOOP
        -- Chamar a RPC existente para recalcular
        -- Ela já deleta cards "a_produzir" e recria baseado na demanda atual
        -- Cards em outras colunas são considerados no cálculo do déficit
