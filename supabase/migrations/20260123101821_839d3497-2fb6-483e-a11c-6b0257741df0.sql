-- Fix: Use correct column names (item_porcionado_id instead of item_id in contagem_porcionados)
-- Also remove reference to loja_itens_porcionados table that doesn't exist
...
BEGIN
    ...
    -- Usando item_porcionado_id (nome correto da coluna)
    -- =====================================================
    SELECT COALESCE(SUM(
