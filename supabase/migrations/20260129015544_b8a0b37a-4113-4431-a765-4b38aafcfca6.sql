-- Fix: Adicionar fallback para usuario_id e usuario_nome quando NULL (chamadas de triggers)
...
DECLARE
    ...
    v_contagem record;
    -- NOVO: Variáveis com fallback para sistema
...
BEGIN
    ...
    FOR v_seq IN 1..v_num_lotes LOOP
        ...
        INSERT INTO producao_registros (
            ...
            p_organization_id,
            v_usuario_id,         -- USANDO VARIÁVEL COM FALLBACK
            v_usuario_nome_final, -- USANDO VARIÁVEL COM FALLBACK
            v_data_hoje,
            v_seq,
            v_num_lotes,
            v_seq > 1,
