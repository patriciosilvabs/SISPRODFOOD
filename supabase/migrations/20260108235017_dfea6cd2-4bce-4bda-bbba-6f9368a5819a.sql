...
-- =====================================================
-- CORREÇÃO: Bug de lotes duplicados quando demanda diminui
-- Problema: Quando demanda cai de N lotes para 1, os lotes
-- excedentes não eram deletados, ficando órfãos.
-- =====================================================

-- 1. LIMPEZA: Remover lotes órfãos existentes para MASSA - PORCIONADO
DELETE FROM producao_registros
WHERE item_id = 'eee53032-12b1-46f9-8712-c001998357c8'
  AND status = 'a_produzir'
  AND sequencia_traco > 1;

-- 2. ATUALIZAR FUNÇÃO com correção do bug
